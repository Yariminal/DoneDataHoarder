"""
Structured logging setup for DoneDataHoarder.
...
Environment:
    DDH_LOG=DEBUG   -> debug level to console + file
...
_DEFAULT_LOG_FILE = _DEFAULT_LOG_DIR / "donedatahoarder.log"
...
def setup_logging(
    ...
    """
    Configure root DoneDataHoarder logger.
    ...
    """
    env_level = os.environ.get("DDH_LOG", "").lower()
    ...
    root_logger = logging.getLogger("donedatahoarder")
